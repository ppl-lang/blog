[ch HTML Code
    ...
    [code language = XML id=html_chapter_example
        <section>
    ...
    Phew! Only a Black-Belt-JSON-Ninja would have no problems writing and maintaining code like this by hand, without editor support. Yet this is just a simple toy example. Imagine a code base with real-world, big and complex HTML code! And image you had to maintain that ... code.
    ...
    As said already, PML has a [xref node_id=lenient_PML text=lenient syntax mode] that leads to very succinct markup code:
    ...
    [img images/bar_graph_characters.png width=500 html_alt=Number of characters in JSON, HTML, pXML, and PML]
