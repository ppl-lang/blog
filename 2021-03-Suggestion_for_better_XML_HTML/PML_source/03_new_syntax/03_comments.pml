[ch Comments
    ...
    There is no ambiguity with [c \[-] being the start of an element with name [c -] because, according to the [xref node_id=name_rules text=rules], an element name cannot contain hyphens ([c -]).
